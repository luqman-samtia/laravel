<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="h-full bg-grey-100">
    <head>
        <meta charset="utf-8">
...
<div class="min-h-full">
        ...
        <div class="flex h-16 items-center justify-between">
          <div class="flex items-center">
            ...
            <div class="hidden md:block">
              <div class="ml-10 flex items-baseline space-x-4">
                ...
                {{-- <a href="{{url('/')}}" class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Home</a> --}}
          ...
          <div class="hidden md:block">
            <div class="ml-4 flex items-center md:ml-6">
                ...
                <form action="" method="">
                    @csrf
                    <x-primary-button href='/logout' >Logout</x-primary-button>
                </form>
        ...
        <div class="border-t border-gray-700 pb-3 pt-4">
          <div class="flex items-center px-5">
            ...
            <div class="ml-3">
              ...
              <div class="text-sm font-medium leading-none text-gray-400">luqmansamtia617@gmail.com</div>
            </div>
    ...
    <header class="bg-white-100 shadow">
      <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8 sm:flex sm:justify-between">
        <h1 class="text-3xl font-bold tracking-tight text-gray-900">{{$heading}}</h1>
        {{-- <a href="/jobs/create" class="btn btn-success">Create </a> --}}
